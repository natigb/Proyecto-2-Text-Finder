 ...
 * palabras o frases en ellos y de visualizar los resultados de b�squeda.
...
public class TextFinderFXMLController implements Initializable {
    ...
    /**
     * Evento para a�adir documento a la libreria
     * @param event
     * @throws IOException 
     */
    @FXML
    ...
    /**
     * A�ade el documento a la biblioteca
     * @param newFile
     * @throws IOException 
     */    
    ...
    /**
     * A�ade la carpeta de documentos 
     * @param p
     * @throws IOException 
     */
    ...
    /**
     * Crea el documento y lo a�ade a la interfaz
     * @param newFile
     * @throws IOException 
     */   
    ...
    /**
     * Funci�n que busca resultados si es una oraci�n
     * @param word 
     */
    ...
    /**
     * En caso de que no se encuentren resultados en el �rbol
     */  
    ...
    /**
     * Muestra en la interfaz, en la parte de resultados, el nombre del documento y el contexto de la primera aparici�n de la 
     * palabra o aparici�n
     * @param docsFound 
     */
    private void showResults(LinkedList<Document> docsFound){
        ...
        public void createResultReference(Document currentDoc,int firstPos, int i,int size){
            ...
            word.setFill(Color.web("#eb4034", 0.8));
        ...
        /**
         * Evento para ordenar los resultados seg�n seg�n el tama�o del documento
         * @param e 
         */
        ...
        /**
         * Evento para ordenar los resultados seg�n seg�n la fecha del documento
         * @param e 
         */
        ...
        /**
         * Evento para ordenar los resultados seg�n seg�n el nombre del documento
         * @param e 
         */
       ...
       /**
        * Selecciona que se quiere buscar por oraci�n
        * @param e 
        */
    ...
    /**
     * Evento para abrir un documento desde la librer�a y mostrar el contenido en la interfaz o para eliminar el documento al 
    ...
    /**
     * Reacomoda los documentos en la librer�a por si se elimina algun documento
     */
